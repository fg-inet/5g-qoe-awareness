...
do
    ...
    do
        ...
        scavetool export -f "(module(*router1.ppp[$sliNum]*) AND name(*xPk*)) OR (module(*router1.ppp[$sliNum]*) AND name(*packetP*))"  -F CSV-S -o ${resultsFolder}/${subfolderName}/vectors/${experimentDescriptor}_${totalNum}_VID${nVID}_LVD${nLVD}_FDO${nFDO}_SSH${nSSH}_VIP${nVIP}_resAllocLink${sliNum}_vec.csv ${sourceFolder}/*-${run_num}.vec
    done
