...
#include "inet/applications/tcpapp/TcpSimpleSshAppV2.h"
...
Define_Module(TcpSimpleSshAppV2);


TcpSimpleSshAppV2::~TcpSimpleSshAppV2()
{
    cancelAndDelete(timeoutMsg);
}

void TcpSimpleSshAppV2::checkedScheduleAt(simtime_t t, cMessage *msg)
{
    if (stopTime < SIMTIME_ZERO || t < stopTime)
        scheduleAt(t, msg);
}

void TcpSimpleSshAppV2::initialize(int stage)
{
...
void TcpSimpleSshAppV2::handleStartOperation(LifecycleOperation *operation)
{
...
void TcpSimpleSshAppV2::handleStopOperation(LifecycleOperation *operation)
{
...
void TcpSimpleSshAppV2::handleCrashOperation(LifecycleOperation *operation)
{
    cancelEvent(timeoutMsg);
...
void TcpSimpleSshAppV2::handleTimer(cMessage *msg)
{
    switch (msg->getKind()) {
...
void TcpSimpleSshAppV2::sendGenericAppMsg(int numBytes, int expectedReplyBytes)
{
...
void TcpSimpleSshAppV2::socketEstablished(TcpSocket *socket)
{
...
void TcpSimpleSshAppV2::socketDataArrived(TcpSocket *socket, Packet *msg, bool urgent)
{
...
void TcpSimpleSshAppV2::socketClosed(TcpSocket *socket)
{
...
void TcpSimpleSshAppV2::socketFailure(TcpSocket *socket, int code)
{
