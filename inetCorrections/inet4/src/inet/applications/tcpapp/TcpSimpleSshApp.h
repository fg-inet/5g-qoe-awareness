...
#ifndef __INET_TcpSimpleSshApp_H
#define __INET_TcpSimpleSshApp_H
 ...
 */
class INET_API TcpSimpleSshApp : public TcpAppBase, public TcpSocket
{
  protected:
...
#endif // ifndef __INET_TcpSimpleSshApp_H
