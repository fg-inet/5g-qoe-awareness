...
#define __INET_TcpSimpleSshAppV2_H
 ...
 */
class INET_API TcpSimpleSshAppV2 : public TcpAppBase//, public TcpSocket
{
  protected:
...
#endif // ifndef __INET_TcpSimpleSshAppV2_H
