...
def plotLSLinkSpeedMeanE2EDScatter(testName, sumNodes, nodeTypes, nodeSplit, pZero):
    ...
    popt, pcov = scipy.optimize.curve_fit(negLinFunc, tps, [x*1000 for x in meanE2EDs], p0=pZero, maxfev=1000000, bounds=(0,np.inf))
    ...
    with np.printoptions(precision=2):
        ...
        ax1.plot(regLine, negLinFunc(regLine, *popt), '-', label=theLabel, color='orange')
